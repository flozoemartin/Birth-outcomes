/*******************************************************************************
	...
	Figure generated by this script
		...
		- strat_preterm_ma.pdf for the main manuscript
		
*******************************************************************************/

* Start logging

	log using "$Logdir\meta analysis\7c_meta analysis strat preterm fig all 3", name(meta_analysis_stratpreterm_fig_all_3) replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	translate "$Logdir\meta analysis\7c_meta analysis strat preterm fig all 3.smcl" "$Logdir\meta analysis\7c_meta analysis strat preterm fig all 3.pdf", replace
	
	erase "$Logdir\meta analysis\7c_meta analysis strat preterm fig all 3.smcl"
