...
* Start logging
	...
	log using "$Logdir\3_figures\13a_right trunc fig data uk", name(right_trunc_fig_data_uk) replace
...
* Get sibling analysis counts from the sibling analysis table (from tabcount)
	...
	import delimited using "$Graphdir\data\right trunc data_uk.txt", varnames(1) clear
	
	save "$Graphdir\data\right trunc data_uk.dta", replace
	
	erase "$Graphdir\data\right trunc data_uk.txt"
	
********************************************************************************

* Stop logging, translate .smcl into .pdf and erase .smcl

	log close right_trunc_fig_data_uk
	
	translate "$Logdir\3_figures\13a_right trunc fig data uk.smcl" "$Logdir\3_figures\13a_right trunc fig data uk.pdf", replace
	
	erase "$Logdir\3_figures\13a_right trunc fig data uk.smcl"
