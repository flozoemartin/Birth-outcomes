...
* Start logging
	...
	log using "$Logdir\meta analysis\5c_meta analysis add adj fig all 3", name(meta_analysis_addadj_fig_all_3) replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close meta_analysis_addadj_fig_all_3
	
	translate "$Logdir\meta analysis\5c_meta analysis add adj fig all 3.smcl" "$Logdir\meta analysis\5c_meta analysis add adj fig all 3.pdf", replace
	
	erase "$Logdir\meta analysis\5c_meta analysis add adj fig all 3.smcl"
