...
* Start logging
	...
	log using "$Logdir\3_figures\9b_combining trimester spec data", name(combining_trimester_spec_data) replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	translate "$Logdir\3_figures\9b_combining trimester spec data.smcl" "$Logdir\3_figures\9b_combining trimester spec data.pdf", replace
	
	erase "$Logdir\3_figures\9b_combining trimester spec data.smcl"
