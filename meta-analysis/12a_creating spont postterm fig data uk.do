...
* Start logging
	...
	log using "$Logdir\3_figures\12a_spont postterm fig data uk", name(spont_postterm_fig_data_uk) replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	translate "$Logdir\3_figures\12a_spont postterm fig data uk.smcl" "$Logdir\3_figures\12a_spont postterm fig data uk.pdf", replace
	
	erase "$Logdir\3_figures\12a_spont postterm fig data uk.smcl"
