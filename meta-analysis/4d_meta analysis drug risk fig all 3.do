/*******************************************************************************
	...
	Creating the figure for meta-analysis adjusted absolute risk
...
* Start logging
	...
	log using "$Logdir\meta analysis\4d_meta analysis drug risk fig all 3", name(drug_risk_all3) replace
	
********************************************************************************

	import delimited using "$NOTabledir\august 24\adjusted absolute risk.txt", clear
	...
	* Generate variables for second axis (to make box around the graph using scatter)
	...
	graph export "$Graphdir\ch6_drug_risk_fig.pdf", replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close drug_risk_all3
	
	translate "$Logdir\meta analysis\4d_meta analysis drug risk fig all 3.smcl" "$Logdir\meta analysis\4d_meta analysis drug risk fig all 3.pdf", replace
	
	erase "$Logdir\meta analysis\4d_meta analysis drug risk fig all 3.smcl"
