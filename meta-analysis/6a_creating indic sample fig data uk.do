/*******************************************************************************
	...
	Data generated by this script
		...
		- uk_counts_indicsample.dta
		
*******************************************************************************/

* Start logging

	log using "$Logdir\meta analysis\6a_creating indic sample fig data uk", name(creating_indic_fig_data_uk) replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close creating_indic_fig_data_uk
	
	translate "$Logdir\meta analysis\6a_creating indic sample fig data uk.smcl" "$Logdir\meta analysis\6a_creating indic sample fig data uk.pdf", replace
	
	erase "$Logdir\meta analysis\6a_creating indic sample fig data uk.smcl"
