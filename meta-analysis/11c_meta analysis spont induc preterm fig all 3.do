/*******************************************************************************
	...
	Creating a stratified preterm sensitivity analysis figure for all three countries
	...
	Figure generated by this script
		...
		- spontinducpt_ma.pdf for the main manuscript
		
*******************************************************************************/

* Start logging

	log using "$Logdir\meta analysis\11c_meta analysis spont induc preterm fig all 3", name(meta_analysis_stratpreterm_fig_all_3) replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close meta_analysis_stratpreterm_fig_all_3
	
	translate "$Logdir\meta analysis\11c_meta analysis spont induc preterm fig all 3.smcl" "$Logdir\meta analysis\11c_meta analysis spont induc preterm fig all 3.pdf", replace
	
	erase "$Logdir\meta analysis\11c_meta analysis spont induc preterm fig all 3.smcl"
