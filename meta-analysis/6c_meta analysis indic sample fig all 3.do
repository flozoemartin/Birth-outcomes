/*******************************************************************************
	...
	Creating an indication-based sensitivity analysis figure for all three countries
	...
	Figure generated by this script
		...
		- indic_sample_ma.pdf for the main manuscript
		
*******************************************************************************/

* Start logging

	log using "$Logdir\meta analysis\6c_meta analysis indic sample fig all 3", name(meta_analysis_indic_fig_all_3) replace
...
* Make the maternal meta-analysis figure for supplementary material and generate the summary effect estimate for the primary figure
	...
	* Save graph
	...
	graph export "$Graphdir\indic_sample_ma.pdf", replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close meta_analysis_indic_fig_all_3
	
	translate "$Logdir\meta analysis\6c_meta analysis indic sample fig all 3.smcl" "$Logdir\meta analysis\6c_meta analysis indic sample fig all 3.pdf", replace
	
	erase "$Logdir\meta analysis\6c_meta analysis indic sample fig all 3.smcl"
