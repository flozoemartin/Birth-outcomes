/*******************************************************************************
	...
	Creating a trimester-specific analysis figure for all three countries
	...
	Figure generated by this script
		...
		- trimester_specific_all3.pdf for the main manuscript
		
*******************************************************************************/

* Start logging

	log using "$Logdir\meta analysis\9c_meta analysis trimester spec fig all 3", name(meta_analysis_trimspec_fig_all_3) replace
...
********************************************************************************
	...
	* Macros to create the null line
	...
	graph export "$graphdir\ch6_trimester_fig.pdf", replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close meta_analysis_trimspec_fig_all_3
	
	translate "$Logdir\meta analysis\9c_meta analysis trimester spec fig all 3.smcl" "$Logdir\meta analysis\9c_meta analysis trimester spec fig all 3.pdf", replace
	
	erase "$Logdir\meta analysis\9c_meta analysis trimester spec fig all 3.smcl"
