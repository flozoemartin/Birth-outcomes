/*******************************************************************************
	...
	Data generated by this script
		...
		- preterm type data_uk.txt stratified preterm delivery sensitivity analysis data in UK
		
*******************************************************************************/

* Start logging

	log using "$Logdir\meta analysis\7a_creating preterm type fig data uk", name(creating_preterm_fig_data_uk) replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close creating_preterm_fig_data_uk
	
	translate "$Logdir\meta analysis\7a_creating preterm type fig data uk.smcl" "$Logdir\meta analysis\7a_creating preterm type fig data uk.pdf", replace
	
	erase "$Logdir\meta analysis\7a_creating preterm type fig data uk.smcl"
