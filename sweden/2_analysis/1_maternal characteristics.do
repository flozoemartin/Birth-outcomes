...
* Start logging
	...
	log using "$Logdir\2_analysis\1_maternal characteristics", name(characteristics) replace
...
* Maternal educational attainment - not available in UK
	...
	tabulatevariable, variable(mother_educ) start(0) end(0) outcome(any_preg)
	
	file write tablecontent "Secondary"
	tabulatevariable, variable(mother_educ) start(1) end(1) outcome(any_preg)
	
	file write tablecontent "Post-secondary"
	tabulatevariable, variable(mother_educ) start(2) end(2) outcome(any_preg)
	
	file write tablecontent "Post-graduate"
	tabulatevariable, variable(mother_educ) start(3) end(3) outcome(any_preg)
	
	file write tablecontent "Missing (likely educated overseas)"
	tabulatevariable, variable(mother_educ) start(4) end(4) outcome(any_preg)
...
* Household disposable income - not available in UK or Norway
	...
	tabulatevariable, variable(dispink5atbirth) start(1) end(1) outcome(any_preg)
	
	file write tablecontent "2"
	tabulatevariable, variable(dispink5atbirth) start(2) end(2) outcome(any_preg)
	
	file write tablecontent "3"
	tabulatevariable, variable(dispink5atbirth) start(3) end(3) outcome(any_preg)
	
	file write tablecontent "4"
	tabulatevariable, variable(dispink5atbirth) start(4) end(4) outcome(any_preg)
	
	file write tablecontent "5"
	tabulatevariable, variable(dispink5atbirth) start(5) end(5) outcome(any_preg)
	
	file write tablecontent "Missing"
	tabulatevariable, variable(dispink5atbirth) start(9) end(9) outcome(any_preg)
...
* Maternal country of birth - not available in UK
	...
	tabulatevariable, variable(mother_birth_country_nonsverige) start(1) end(1) outcome(any_preg)
	
	file write tablecontent "Missing"
	tabulatevariable, variable(mother_birth_country_nonsverige) start(9) end(9) outcome(any_preg)
...
* History of stillbirth
		...
		tabulatevariable, variable(prev_sb_bin) start(1) end(1) outcome(any_preg)
		
		file write tablecontent "Missing" 
		tabulatevariable, variable(prev_sb_bin) start(9) end(9) outcome(any_preg)
...
* Parity
		...
		file write tablecontent "Missing"
	tabulatevariable, variable(parity) start(9) end(9) outcome(any_preg)
...
/* Other maternal comorbidities
		...
		tabulatevariable, variable(hypbp) start(1) end(1) outcome(any_preg)
		...
		tabulatevariable, variable(diab) start(1) end(1) outcome(any_preg)
...
* Iniiation of labour
		...
		file write tablecontent "Missing" 
		tabulatevariable, variable(induction) start(9) end(9) outcome(any_preg)
		
********************************************************************************

* Stop logging, translate .smcl into .pdf and erase .smcl

	log close characteristics
	
	translate "$Logdir\2_analysis\1_maternal characteristics.smcl" "$Logdir\2_analysis\1_maternal characteristics.pdf", replace
	
	erase "$Logdir\2_analysis\1_maternal characteristics.smcl"
