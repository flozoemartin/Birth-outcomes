...
/*******************************************************************************
	...
	Linear regression and logisitic regression models of birthweight birth weight / small for gestational age by drug
	...
	Table generated by this script
		...
		- sga by drug.txt - birth weight and small for gestational age by drug 
...
********************************************************************************	
	...
	*gen cc = 1 if birth_yr!=. & mother_age_cat!=. & mother_educ!=. & dispink5atbirth!=. & mother_birth_country_nonsverige!=. & mother_bmi_cat!=. & smoke_preg!=. & prev_sb_bin!=. & parity!=. & ap_12mo!=. & asm_12mo!=. & depression!=. & anxiety!=.
	...
	forvalues n=0/11 {
		...
		regress birth_weight i.drug_preg birth_yr i.mother_age_cat i.mother_educ i.dispink5atbirth i.mother_birth_country_nonsverige i.mother_bmi_cat i.smoke_preg i.prev_sb_bin i.parity i.ap_12mo i.asm_12mo depression anxiety, vce(cluster mother_id)
		...
		if `rd'==0 {
			...
			file write `myhandle' _tab %4.0f (`mean') _tab ("0") _tab ("reference") _tab ("-")
					
		}
				
		else if `rd'!=0 {
					
			file write `myhandle' _tab %4.0f (`mean') _tab %4.0f (`rd') _tab %4.0f (`lci') (",") (" ") %4.0f (`uci') _tab %4.3f (`p')
					
		}
				
		logit sga_pct i.drug_preg birth_yr i.mother_age_cat i.mother_educ i.dispink5atbirth i.mother_birth_country_nonsverige i.mother_bmi_cat i.smoke_preg i.prev_sb_bin i.parity i.ap_12mo i.asm_12mo depression anxiety, or vce(cluster mother_id)
