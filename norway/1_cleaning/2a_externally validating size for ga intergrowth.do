...
* Load in the data 
	...
	keep child_id preg_id birth_weight child_male gest_age_child
	
	summ birth_weight
	
	gen birweit_kg = birth_weight/1000
	gen gestwks = gest_age_child/7
	...
	* Create variable 
	...
	foreach sex in 0 1 {
	    forvalues week = 168(1)230 {
		   ...
		   replace sga_vpt_ex = 1 if gest_age_child==(`week') & birweit_kg<(`cut_`sex'_`week'_10_vpt') & child_male==(`sex')
		   replace lga_vpt_ex = 1 if gest_age_child==(`week') & birweit_kg>(`cut_`sex'_`week'_90_vpt') & child_male==(`sex')
	...
	foreach sex in 0 1 {
	    forvalues week = 231(1)300 {
		   ...
		   replace sga_ex = 1 if gest_age_child==(`week') & birweit_kg<(`cut_`sex'_`week'_10') & child_male==(`sex')
		   replace lga_ex = 1 if gest_age_child==(`week') & birweit_kg>(`cut_`sex'_`week'_90') & child_male==(`sex')
	...
	keep child_id preg_id sga_ex lga_ex nga_ex
