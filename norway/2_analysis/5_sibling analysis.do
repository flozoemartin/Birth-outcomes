...
* Start logging
	...
	log using "$Logdir\2_analysis\5_sibling analysis", name(sibling_analysis) replace
...
* Load in the analysis dataset
	...
	* Sibling analysis data management
	...
	preserve
		...
		sort mother_id preg_id start_date
		
		duplicates drop mother_id preg_id, force // checking that there're no multiple pregnancies still in 
	...
	* deviation from family averaged covariate 
	...
	foreach covar in birth_yr mother_age_cat mother_educ parity ap_12mo asm_12mo healthcare_util_12mo_cat depression anxiety {
	...
	* Family averaged covariates for shared covariates
	...
	foreach covar in birth_yr ap_12mo asm_12mo healthcare_util_12mo depression anxiety {
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	translate "$Logdir\2_analysis\5_sibling analysis.smcl" "$Logdir\2_analysis\5_sibling analysis.pdf", replace
	
	erase "$Logdir\2_analysis\5_sibling analysis.smcl"
