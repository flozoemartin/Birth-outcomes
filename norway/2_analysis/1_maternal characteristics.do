/*******************************************************************************
	...
	Generate table for Norwegian registry project for antidepressant use during pregnancy and birth outcomes (mimicing the CPRD characteristics table as closely as possible)
	...
	Table generated by this script
		...
		- maternal characteristics.txt maternal characteristics by maternal exposure
		
*******************************************************************************/

* Start logging

	log using "$Logdir\2_analysis\1_maternal characteristics table", name(maternal_characteristics_table) replace
...
********************************************************************************
		...
		file open tablecontent using "$Tabledir\maternal characteristics.txt", write text replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close maternal_characteristics_table
	
	translate "$Logdir\2_analysis\1_maternal characteristics table.smcl" "$Logdir\2_analysis\1_maternal characteristics table.pdf", replace
	
	erase "$Logdir\2_analysis\1_maternal characteristics table.smcl"
