/*******************************************************************************
	...
	Table generated by this script
		...
		- indic sample data_no.txt unrounded estimates and counts for figure creation
		
*******************************************************************************/

* Start logging

	log using "$Logdir\2_analysis\14_strat by indication", name(sens_strat_by_indic) replace
...
********************************************************************************	
	...
	foreach outcome in stillborn neonatal_death preterm postterm sga_pct lga_pct apgar5_bin { 
		...
		* Adjusted for all covariates
			...
			logistic `outcome' i.any_preg birth_yr i.mother_age_cat i.mother_educ i.mother_birth_country_nonnorge i.prev_sb_bin i.parity i.ap_12mo i.asm_12mo healthcare_util_12mo, vce(cluster mother_id) or
...
* FIGURE DATA
	...
	tempname myhandle	
	file open `myhandle' using "$Tabledir\indic sample data_no.txt", write replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	translate "$Logdir\2_analysis\14_strat by indication.smcl" "$Logdir\2_analysis\14_strat by indication.pdf", replace
	
	erase "$Logdir\2_analysis\14_strat by indication.smcl"
	
********************************************************************************stratified by indication sensitivity
