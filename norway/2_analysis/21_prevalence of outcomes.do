/*******************************************************************************
	...
	Generate table showing the prevalence of each outcome in the analysis stratified by antidepressant use during pregnancy
	...
	Table generated by this script
		...
		- prevalence of outcomes.txt prevalences of the outcomes between exposed and unexposed
		
*******************************************************************************/

* Start logging

	log using "$Logdir\2_analysis\21_prevalence of outcomes", name(prevalence_of_outcomes) replace
...
* Set up output file
		...
		rename nga_ex_intergrowth aga_ex_intergrowth
		rename nga_ex_swedish aga_ex_swedish
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close prevalence_of_outcomes
	
	translate "$Logdir\2_analysis\21_prevalence of outcomes.smcl" "$Logdir\2_analysis\21_prevalence of outcomes.pdf", replace
	
	erase "$Logdir\2_analysis\21_prevalence of outcomes.smcl"
