/*******************************************************************************
	...
	Tables generated by this script
		...
		- right trunc data_no.txt unrounded estimates and counts for figure creation
		
*******************************************************************************/

* Start logging

	log using "$Logdir\2_analysis\16_postterm full follow up", name(postterm_full_follow_up) replace
...
* FIGURE DATA
	...
	tempname myhandle	
	file open `myhandle' using "$Tabledir\right trunc data_no.txt", write replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	translate "$Logdir\2_analysis\16_postterm full follow up.smcl" "$Logdir\2_analysis\16_postterm full follow up.pdf", replace
	
	erase "$Logdir\2_analysis\16_postterm full follow up.smcl"
