...
* Start logging
	...
	log using "$Logdir\2_analysis\2_prevalence of outcomes", name(prevalence_of_outcomes) replace
...
********************************************************************************
	...
	gen byte total=1
		...
		file write tablecontent "Neonatal death" _n
		
		file write tablecontent "Apgar score < 7 at 5 mins" _n
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	translate "$Logdir\2_analysis\2_prevalence of outcomes.smcl" "$Logdir\2_analysis\2_prevalence of outcomes.pdf", replace
	
	erase "$Logdir\2_analysis\2_prevalence of outcomes.smcl"
