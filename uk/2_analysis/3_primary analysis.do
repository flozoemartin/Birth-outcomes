...
* Start logging
	...
	log using "$Logdir\2_analysis\3_primary analysis", name(primary_analysis) replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	translate "$Logdir\2_analysis\3_primary analysis.smcl" "$Logdir\2_analysis\3_primary analysis.pdf", replace
	
	erase "$Logdir\2_analysis\3_primary analysis.smcl"
