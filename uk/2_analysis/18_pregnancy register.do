/*******************************************************************************
	...
	Generate table showing the primary analysis models in the whole Pregnancy Register population
	...
	Table generated by this script
		...
		- pregnancy register.txt primary analysis logisitic regression models in the whole Pregnancy Register sample
		
*******************************************************************************/

* Start logging

	log using "$Logdir\2_analysis\18_pregnancy register", name(pregnancy_register) replace
	
********************************************************************************	

	tempname myhandle	
	file open `myhandle' using "$Tabledir\pregnancy register.txt", write replace
	...
	foreach outcome in stillborn preterm preterm_ev postterm postterm_ev { 
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close pregnancy_register
	
	translate "$Logdir\2_analysis\18_pregnancy register.smcl" "$Logdir\2_analysis\18_pregnancy register.pdf", replace
	
	erase "$Logdir\2_analysis\18_pregnancy register.smcl"
