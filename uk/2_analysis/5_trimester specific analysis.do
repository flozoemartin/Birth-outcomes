...
********************************************************************************	
	...
	gen cc = 1 if birth_yr_cat!=. & mother_age_cat!=. & imd_practice!=. & mother_ethn!=. & parity!=. & ap_12mo!=. & asm_12mo!=. & depression!=. & anxiety!=. & CPRD_consultation_events_cat!=. & smoke_preg!=.
		...
		* Recode incident users after 37 weeks' unexposed for the preterm delivery modesls
		...
		forvalues x=1/3 {
			...
			* Adjusted for all covariates
			...
			logistic `outcome' i.t`x' birth_yr i.mother_age_cat i.mother_ethn i.imd_practice i.smoke_preg i.grav_hist_sb i.parity i.ap_12mo i.asm_12mo CPRD_consultation_events_cat depression anxiety, or
